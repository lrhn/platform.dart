...
import 'platform_specific/platforms_test_base.dart';
import 'zone_overrides.dart' as overrides;
import 'json_keys.dart' as json_key;

/// Fake Dart runtime platform information.
///
/// Implements [Platform], but allows a [FakeBrowserPlatform],
/// [FakeNativePlatform] or [FakeWasmPlatform] to be the
/// non-`null` platform object.
@visibleForTesting
final class FakePlatform extends PlatformTestBase {
  ...
  FakePlatform._native(NativePlatform this.nativePlatform)
      : browserPlatform = null,
        wasmPlatform = null;
  FakePlatform._browser(BrowserPlatform this.browserPlatform)
      : nativePlatform = null,
        wasmPlatform = null;
  FakePlatform._wasm(WasmPlatform this.wasmPlatform)
      : nativePlatform = null,
        browserPlatform = null;

  /// A platform with *none* of the native, browser or Wasm platforms set.
  FakePlatform.unknown()
      : nativePlatform = null,
        browserPlatform = null,
        wasmPlatform = null;
...
final class FakeWasmPlatform extends WasmPlatformTestBase {
  ...
  String toJson() => const JsonEncoder.withIndent('  ').convert(
      <String, Object?>{if (_version != null) json_key.version: _version});
  ...
  R run<R>(R Function() fakePlatformCode) => overrides.runWith(
      fakePlatformCode, FakePlatform._wasm(this), _OverrideMarker.marker);
}
