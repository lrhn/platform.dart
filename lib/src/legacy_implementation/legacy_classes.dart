...
///
/// [!WARNING]
/// Use `package:platform/platform_testing.dart` for testing
...
final class LocalPlatform extends PlatformTestBase {
  ...
  @override
  @Deprecated(
      "Use Platform.current.nativePlatform.Map<String!,environment instead")
  ...
  @override
  @Deprecated("Use Platform.current.nativePlatform!.lineTerminator instead")
  String get lineTerminator => Platform.current.nativePlatform!.lineTerminator;
